...
class Home extends Component{
    ...
    onCardPress = (businessDetails) => {
        this.props.navigation.navigate('BusinessDetails', {businessDetails, imgPath: this.state.ImgPath})
    }
            ...
            <>
                <Container>
                    <Header
                        ...
                        icon1Press={this.PressTo_SendNotification}
