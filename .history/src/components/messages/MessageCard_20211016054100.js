...
const MessageCard = ({side, data}) => {
    console.log("from", data.fromPhoto)
    console.log("to", data.toPhoto)
    ...
    return(
        <>
            <View style={containerStyles}>
                {isLeftSide &&
                    <Image 
                        source={data.toPhoto == null ? require('../../assets/images/avatar.png') : {uri: data.toPhoto }}
                ...
                {!isLeftSide &&
                    <Image 
                        source={data.fromPhoto ? {uri: data.fromPhoto } : require('../../assets/images/avatar.png')}
                        style={styles.imageStyle}
                    />
                }
            </View>
