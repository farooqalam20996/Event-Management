...
const BusinessDetails = ({route}) => {
    ...
    const imagePath = route.params.businessDetails.imgPath;
    ...
    const sendMessage = () => {
        ...
        //     toPhoto:getImages()[0],
        //     toSqlID:businessDetails.id,
        //     toName: `${businessDetails.name}`,
        //     read: false,
        //     readBy: [],
        // }).then(()=>{
        //     firebase.firestore
        ...
        //             {
        //                 person:{
        //                     idUser: businessDetails.id,
        //                     name:businessDetails.name,
        //                     image: getImages()[0],
        //                     // Photo: this.state.user.Photo
        //                 },
        //                 chatID:`${user.firebase_id}_${businessDetails.firebase_id}`,
        //             }
        //         )
        //     )
        //     .catch((err)=>alert(err))
